...
*/
class matrix {
	public $row; // row number in tableau 
	public $col; // column number in tableau
	public $Tableau; // il tableau
	public $S; // $S[] = (base index => line associated solution)
	public $cambia_segno; // == true se il problema e' di massimo
	public $soln; // the solution in vector form[z|x]
	...
	public function in_S($j) {
		...
		return -1;  //NOTE CHECK IF THIS SHOULD BE INSIDE ELSE
	}
	/*
	 *
